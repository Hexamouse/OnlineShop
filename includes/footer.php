<!-- footer.php -->
<footer class="bg-white text-gray-800 py-8 border-t-4 border-gray-800 rounded-tr-3xl rounded-tl-3xl">
    <div class="container mx-auto w-4/5 flex justify-between items-start mb-6">
        <!-- Brand Section -->
        <div class="w-1/3">
  ...
  <path fill-rule="evenodd" d="M7.5 6v.75H5.513c-.96 0-1.764.724-1.865 1.679l-1.263 12A1.875 1.875 0 0 0 4.25 22.5h15.5a1.875 1.875 0 0 0 1.865-2.071l-1.263-12a1.875 1.875 0 0 0-1.865-1.679H16.5V6a4.5 4.5 0 1 0-9 0ZM12 3a3 3 0 0 0-3 3v.75h6V6a3 3 0 0 0-3-3Zm-3 8.25a3 3 0 1 0 6 0v-.75a.75.75 0 0 1 1.5 0v.75a4.5 4.5 0 1 1-9 0v-.75a.75.75 0 0 1 1.5 0v.75Z" clip-rule="evenodd" />
            ...
            <!-- Alamat ditambahkan di bawah h4 -->
            <p class="text-base text-gray-600">Jalan Raya Lubuk Begalung, 25145</p>
            <p class="text-base text-gray-600">Lubuk Begalung Nan XX</p>
            <p class="text-base text-gray-600">Kec. Lubuk Begalung</p>
            <p class="text-base text-gray-600">Kota Padang</p>
            <p class="text-base text-gray-600">Sumatera Barat</p>
            <p class="text-base text-gray-600">Indonesia</p>
        </div>

        <!-- Customer Service Section -->
        <div class="w-1/3 text-left">
            <h4 class="font-bold mb-4">Layanan Pelanggan</h4>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Bantuan</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Metode Pembayaran</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Dompet</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Lacak Pesanan</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Lacak Pengiriman</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Gratis Ongkir</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Pengembalian Barang</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Pengembalian Dana</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Garansi</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Hubungi CS</a>
        </div>

        
        <!-- Jelajahi Section -->
        <div class="w-1/3 text-left">
            <h4 class="font-bold mb-4">Jelajahi Kami</h4>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Tentang Kami</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Karir</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Kebijakan Kadai Online</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Kebijakan Privasi</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Blog</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Kadai Online Mall</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Seller Centre</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Flash Sale</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Kontak Media</a>
            <a href="#" class="text-gray-600 hover:text-yellow-400 text-base block mb-1">Affiliate</a>
        </div>
    ...
    <div class="container mx-auto w-4/5 flex justify-between items-center">
        ...
        <div class="w-1/2 text-right">
            ...
            <a href="https://www.facebook.com" class="hover:text-yellow-400 mx-2" target="_blank" rel="noopener noreferrer">
                <i class="fab fa-facebook-f"></i>
            </a>
            <a href="https://www.twitter.com" class="hover:text-yellow-400 mx-2" target="_blank" rel="noopener noreferrer">
                <i class="fab fa-twitter"></i>
            </a>
            <a href="https://www.instagram.com" class="hover:text-yellow-400 mx-2" target="_blank" rel="noopener noreferrer">
                <i class="fab fa-instagram"></i>
            </a>
            <a href="https://www.tiktok.com" class="hover:text-yellow-400 mx-2" target="_blank" rel="noopener noreferrer">
                <i class="fab fa-tiktok"></i>
            </a>
            <a href="https://www.linkedin.com" class="hover:text-yellow-400 mx-2" target="_blank" rel="noopener noreferrer">
                <i class="fab fa-linkedin-in"></i>
            </a>
            <a href="https://www.github.com" class="hover:text-yellow-400 mx-2" target="_blank" rel="noopener noreferrer">
    ...
    <div class="container mx-auto w-full">
        <hr class="border-gray-300 my-8 w-4/5 mx-auto">
    </div>

    <div class="container mx-auto w-4/5 text-center mt-8">
        <p class="text-sm">&copy; 2025 Kadai Online. All rights reserved.</p>
    </div>
</footer>
