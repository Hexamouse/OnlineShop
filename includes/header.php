...
<header class="bg-transparent text-gray-800 py-4 shadow-lg border-b-4 border-gray-800 sticky top-0 z-50 transition-all duration-300" id="header">
    <div class="container mx-auto flex justify-between items-center px-8 max-w-screen-xl">
        <!-- Nama Toko -->
        <h1 class="text-3xl font-bold tracking-wide text-gray-800 hover:text-yellow-500 cursor-pointer transition-all duration-300">
            Kadai Online
        </h1>
        ...
        <nav>
            <ul class="flex space-x-4 text-base items-center">
                <?php if (isset($_SESSION['iduser'])): ?>
                    <!-- Opsi Akun jika sudah login -->
                    <li class="flex items-center space-x-2">
                        <a href="profile.php" class="inline-flex items-center space-x-2 py-1 px-3 bg-transparent border-2 border-gray-800 rounded-lg hover:bg-yellow-400 hover:text-gray-900 transition-all duration-300">
