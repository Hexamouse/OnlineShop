...
<head>
    ...
    <title>Beranda | KadaiPedia</title>
...
<body class="bg-gray-100 text-gray-800">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php while ($product = mysqli_fetch_assoc($result)): ?>
                    <div class="bg-white border rounded-lg shadow-lg overflow-hidden">
                        <img src="uploads/<?= $product['foto1']; ?>" alt="<?= $product['nama']; ?>" class="w-full h-48 object-cover">
                        <div class="p-6">
                            ...
                            <a href="/buyer/product/product_detail.php?id=<?= $product['idproduk']; ?>" class="block bg-gray-800 text-white text-center py-2 mt-4 rounded hover:bg-yellow-400">Lihat Detail</a>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
    ...
    <?php include 'includes/sectionAbout.php' ?>
